                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(AppConstants.APP_NAME,
                          style: rubikBold.copyWith(color: Colors.white, fontSize: 25),
                  ...
                  delegate: SliverDelegate(child: Center(
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(color: Theme.of(context).primaryColor,borderRadius: BorderRadius.only(
                          topLeft: Radius.circular(0),
                          topRight: Radius.circular(0),
                          bottomLeft: Radius.circular(15),
                          bottomRight: Radius.circular(20),
                        ),),
                        padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_LARGE, vertical: 6),
                        child: Container(
                          decoration: BoxDecoration(color: ColorResources.getSearchBg(context), borderRadius: BorderRadius.circular(10)),
                          child: Row(children: [
                            Padding(padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_SMALL), child: Icon(Icons.search, size: 18,color: Theme.of(context).primaryColor,)),
                            Expanded(child: Text(getTranslated('search_items_here', context), style: rubikRegular.copyWith(fontSize: 18))),
                          ]),
                        ),
                      ),
                    ),
                          ...
                          child: SizedBox(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Padding(
                                ...
                                child: Align(
                                  alignment: Alignment.center,
                                  child: Text(getTranslated('popular_item', context),style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_THIRTY, color: Colors.red)),
                                ),
                              )
                                  : Padding(
