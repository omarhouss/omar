...
class _OfferProductWebViewState extends State<OfferProductWebView> {
  ...
  Widget build(BuildContext context) {
    bool _data = Provider.of<ProductProvider>(context, listen: false).productReviewList == null ? false : Provider.of<ProductProvider>(context, listen: false).offerProductList.length >= 5;
